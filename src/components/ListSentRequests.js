...
export default function ListSentRequests() {
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:3002/${userid}/sent-requests`)
...
const handleClickToOpen = (rowdata) => {
  ...
  const [columns, setColumns] = useState([
    ...
    { title: 'Request Status', field: 'availability_status' , render : (rowData) => {
      console.log("rowdata " , rowData)
      if(rowData.availability_status == false){
